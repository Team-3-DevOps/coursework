...
| -- |:--------:|:-----------:|:------------:|:--------:|
| 1 | Set-up and documentation | <li>Development environemnt creation: initial set-ups and integrations are included</li> | <ul><li>As a project owner, I have conducted norms and product backlog for team. Advices and suggestions are provided</li><li> As a developer, I set up and build Travis C, Correct branches for gitflow and first release created on GitHub</li><li>As a group member, I set up Github project for Coursework, and made project builds to self-contained JAR with Maven. Then, created dockerfile for project set-up and it works </li><li>As a scrum master, I created code of conduct which team member should follow and it will motivate team members to be comfortable and passionate for the project</li></ul> | High |
